...
int main() {
    ...
    int num1 = 5, num2 = 2;  // 'num1' e 'num2' armazenam valores inteiros para as operações.
    int soma, sub, mult, div, resto;  // Variáveis que armazenarão os resultados das operações.
